...
<table border="0" style="width: 100%; text-align: center;">
  <tr>
    <td align="center">
      <video src="assets/videos/boat_sailing.mp4" width="100%" autoplay loop muted playsinline controls></video>
      <br><em>"A boat sailing smoothly on a calm lake."</em>
    </td>
    <td align="center">
      <video src="assets/videos/canoeing.mp4" width="100%" autoplay loop muted playsinline controls></video>
      <br><em>"A person is canoeing or kayaking."</em>
    </td>
    <td align="center">
      <video src="assets/videos/shanghai_oil_painting.mp4" width="100%" autoplay loop muted playsinline controls></video>
      <br><em>"The bund Shanghai, oil painting."</em>
    </td>
  </tr>
  <tr>
    <td align="center">
      <video src="assets/videos/bakery_shop.mp4" width="100%" autoplay loop muted playsinline controls></video>
      <br><em>"A bakery shop."</em>
    </td>
    <td align="center">
      <video src="assets/videos/bigfoot_snowstorm.mp4" width="100%" autoplay loop muted playsinline controls></video>
      <br><em>"A bigfoot walking in the snowstorm."</em>
    </td>
    <td align="center">
    </td>
  </tr>
